...
async function main() {
  switch (cmd) {
    ...
    default:
      ...
      console.error("usage: pebble-mcp [serve|init|verify|status|hot-cache-for-cc|hot-cache-for-droid|hot-cache-for-gemini|seed-test-fixture|commit-turn|review-turn|render-vault]");
      process.exit(1);
  }
}
